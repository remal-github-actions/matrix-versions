...
var __toCommonJS = (mod) => __copyProps(prettier_defProp({}, "__esModule", { value: true }), mod);
...
var source_exports = {};
prettier_export(source_exports, {
  Chalk: () => Chalk,
...
async function importPlugin(name, cwd) {
  if (external_path_.isAbsolute(name)) {
    return __webpack_require__(15435)((0,external_url_.pathToFileURL)(name).href);
  }
  try {
